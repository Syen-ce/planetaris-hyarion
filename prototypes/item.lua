...
data:extend({
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/raw-diamond-1.png",
    pictures =
    {
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/raw-diamond-1.png",   scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/raw-diamond-2.png", scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/raw-diamond-3.png", scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/raw-diamond-4.png", scale = 0.5, mipmap_count = 4 },
    },
  ...
  },
  {
    ...
    },
    {
        ...
        icon = "__planetaris-hyarion__/graphics/icons/quartz.png",
        subgroup = "hyarion-gems",
        order = "a[basic]-b-b",
        stack_size = 100,
        weight = 5*kg,
...
-----------------------------------------------------------------
  ...
  },
  {
    ...
    order = "p[planetaris]-b[hyarion]-a",
  ...
  },
  {
    ...
    subgroup = "environmental-protection",
    order = "p[planetaris]-b[hyarion]-b",
  ...
  },
  {
    ...
    icon="__planetaris-hyarion__/graphics/icons/fluorite-2.png",
    subgroup = "hyarion-gems",
    ...
    pictures =
    {
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/fluorite.png",   scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/fluorite-2.png", scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/fluorite-3.png", scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/fluorite-4.png", scale = 0.5, mipmap_count = 4 },
    },
  ...
  },
  {
    ...
    pictures =
    {
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/charged-fluorite.png",   scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/charged-fluorite-2.png", scale = 0.5, mipmap_count = 4 },
      { size = 64, filename = "__planetaris-hyarion__/graphics/icons/charged-fluorite-3.png", scale = 0.5, mipmap_count = 4 },
  ...
  },
  {
    ...
    subgroup = "hyarion-production",
    order = "a-d-b",
    place_result = "planetaris-refraction-generator",
    stack_size = 50,
    weight = 100*kg,
    default_import_location = "hyarion",
  ...
  },
  {
    ...
    stack_size = 200,
    weight = 2*kg,
    place_result = "planetaris-fiber-optics-cable",
    default_import_location = "hyarion",
  ...
  },
  {
    ...
    subgroup = "turret",
    order = "b[turret]-b[laser-turret]-b[ruby]",
    inventory_move_sound = item_sounds.turret_inventory_move,
    pick_sound = item_sounds.turret_inventory_pickup,
    drop_sound = item_sounds.turret_inventory_move,
    place_result = "planetaris-ruby-laser-turret",
    stack_size = 50,
    weight = 40*kg
  },
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/personal-ruby-laser-defense-equipment.png",
    place_as_equipment_result = "planetaris-personal-ruby-laser-defense-equipment",
    subgroup = "military-equipment",
    order = "b[active-defense]-a[personal-laser-defense-equipment]-b[personal-ruby-laser-defense-equipment]",
    inventory_move_sound = item_sounds.turret_inventory_move,
    pick_sound = item_sounds.turret_inventory_pickup,
    drop_sound = item_sounds.turret_inventory_move,
    stack_size = 10,
  ...
  },  
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/transistor.png",
    subgroup = "space-facilities",
    order = "a-b-a",
    stack_size = 50,
    weight = 20*kg,
  ...
  },
  {
    ...
    localised_description = {"entity-description.planetaris-zero-grav-accumulator"},
    icon = "__planetaris-hyarion__/graphics/icons/zero-gravity-accumulator.png",
    subgroup = "space-facilities",
    order = "a-c-a",
    place_result = "planetaris-zero-grav-accumulator",
    stack_size = 50,
    weight = 20*kg,
    default_import_location = "hyarion",
    ...
    order = "d[radar]-a[radar]-b",
    inventory_move_sound = item_sounds.metal_large_inventory_move,
    pick_sound = item_sounds.metal_large_inventory_pickup,
    drop_sound = item_sounds.metal_large_inventory_move,
    place_result = "planetaris-electromagnetic-radar",
    stack_size = 50,
    random_tint_color = item_tints.iron_rust
  },
})