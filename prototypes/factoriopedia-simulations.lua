...
simulations.factoriopedia_big_bismuth_asteroid = { hide_factoriopedia_gradient = true, init = make_asteroid_simulation("big-bismuth-asteroid", "12") }
simulations.factoriopedia_huge_bismuth_asteroid = { hide_factoriopedia_gradient = true, init = make_asteroid_simulation("huge-bismuth-asteroid", "19") }
