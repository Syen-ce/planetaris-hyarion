...
--------------------------------------------------
--bismuth-asteroid-particles

particle_animations.get_bismuth_asteroid_particle_small_pictures = function(options)
  local options = options or {}
  return {
    sheet = {
      filename = "__planetaris-hyarion__/graphics/particle/asteroid-particle/bismuth-asteroid-particle-small.png",
      priority = "extra-high",
      width = 12,
      height = 12,
      frame_count = 12,
...
particle_animations.get_bismuth_asteroid_particle_medium_pictures = function(options)
  ...
  return {
    sheet = {
      filename = "__planetaris-hyarion__/graphics/particle/asteroid-particle/bismuth-asteroid-particle-medium.png",
      priority = "extra-high",
      width = 18,
      height = 16,
      frame_count = 12,
...
particle_animations.get_bismuth_asteroid_particle_big_pictures = function(options)
  ...
  return {
    sheet = {
      filename = "__planetaris-hyarion__/graphics/particle/asteroid-particle/bismuth-asteroid-particle-big.png",
      priority = "extra-high",
      width = 38,
      height = 36,
      frame_count = 12,
...
particle_animations.get_bismuth_asteroid_particle_top_small_pictures = function(options)
  ...
  return {
    sheet = {
      filename = "__planetaris-hyarion__/graphics/particle/asteroid-particle/bismuth-asteroid-particle-top-small.png",
      priority = "extra-high",
      width = 32,
      height = 36,
      frame_count = 16,
...
particle_animations.get_bismuth_asteroid_particle_top_big_pictures = function(options)
  ...
  return {
    sheet = {
      filename = "__planetaris-hyarion__/graphics/particle/asteroid-particle/bismuth-asteroid-particle-top-big.png",
      priority = "extra-high",
      width = 82,
      height = 84,
      frame_count = 16,
