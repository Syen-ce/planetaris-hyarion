...
local bismuth_asteroids_sounds = require ("__planetaris-hyarion__.prototypes.entities.asteroids.sounds")

data:extend({

  ------------------  bismuth-asteroid-explosionss
  ...
  --bismuth-chunk
  {
    ...
    sound = bismuth_asteroids_sounds.asteroid_collision_bismuth_small,
    created_effect = {
      type = "direct",
      action_delivery =
      {
        ...
        {
          {
            ...
            repeat_count = 6,
            probability = 1,
            smoke_name = "asteroid-smoke-bismuth-chunk",
   ...
   --bismuth-small
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/small-bismuth-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
    animations = explosion_animations.asteroid_explosion_small({tint = {0.6118, 0.4980, 0.4745, 1}}),
    sound = bismuth_asteroids_sounds.asteroid_damage_bismuth_small,
    created_effect = {
      type = "direct",
      action_delivery =
      {
        ...
        {
          {
            type = "create-trivial-smoke",
            repeat_count = 15,
            smoke_name = "asteroid-smoke-bismuth-small",
  ...
  --bismuth-medium
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/medium-bismuth-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
    animations = explosion_animations.asteroid_explosion_medium({tint = {0.6118, 0.4980, 0.4745, 1}}),
    sound = bismuth_asteroids_sounds.asteroid_damage_bismuth_medium,
    created_effect = {
      type = "direct",
      action_delivery =
      {
        ...
        {
          {
            type = "create-trivial-smoke",
            repeat_count = 25,
            smoke_name = "asteroid-smoke-bismuth-medium",
  ...
  --bismuth-big
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/big-bismuth-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
    animations = explosion_animations.asteroid_explosion_big({tint = {0.6118, 0.4980, 0.4745, 1}}),
    sound = bismuth_asteroids_sounds.asteroid_damage_bismuth_big,
    created_effect = {
      type = "direct",
      action_delivery =
      {
        ...
        {
          {
            type = "create-trivial-smoke",
            repeat_count = 50,
            smoke_name = "asteroid-smoke-bismuth-big",
  ...
  --bismuth-huge
  {
    ...
    icon = "__planetaris-hyarion__/graphics/icons/huge-bismuth-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
    animations = explosion_animations.asteroid_explosion_huge({tint = {0.6118, 0.4980, 0.4745, 1}}),
    sound = bismuth_asteroids_sounds.asteroid_damage_bismuth_huge,
    created_effect = {
      type = "direct",
      action_delivery = {
        type = "instant",
        target_effects = {
          {
            type = "create-trivial-smoke",
            repeat_count = 120,
            smoke_name = "asteroid-smoke-bismuth-huge",
            offset_deviation = { { -3.5, -3.5 }, { 3.5, 3.5 } },
            initial_height = 0,
