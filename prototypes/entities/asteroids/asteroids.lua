...
local simulations = require("__planetaris-hyarion__.prototypes.factoriopedia-simulations")
...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  ...
  {
    color_texture = {
      filename = "__planetaris-hyarion__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    normal_map = {
      filename = "__planetaris-hyarion__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-normal-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    },
    ...
    roughness_map = {
      filename = "__planetaris-hyarion__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-roughness-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    }
    ...
    data:extend({
      {
        ...
        icon = "__planetaris-hyarion__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
