local particle_animations = require("__planetaris-hyarion__/prototypes/entities/asteroids/particle-animations.lua")
...
local particles = {
  make_particle{
    ...
    life_time = 25,
    pictures = particle_animations.get_bismuth_asteroid_particle_small_pictures(),
    shadows = particle_animations.get_bismuth_asteroid_particle_small_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
  ...
  make_particle{
    ...
    life_time = 45,
    pictures = particle_animations.get_bismuth_asteroid_particle_medium_pictures(),
    shadows = particle_animations.get_bismuth_asteroid_particle_medium_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
    regular_trigger_effect = nil,
    render_layer_when_on_ground = "lower-object-above-shadow"
  },
  make_particle{
    ...
    life_time = 82,
    pictures = particle_animations.get_bismuth_asteroid_particle_top_small_pictures(),
    shadows = particle_animations.get_bismuth_asteroid_particle_top_small_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
    regular_trigger_effect = nil,
  ...
  make_particle{
    ...
    life_time = 78,
    pictures = particle_animations.get_bismuth_asteroid_particle_top_big_pictures(),
    shadows = particle_animations.get_bismuth_asteroid_particle_top_big_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
    regular_trigger_effect = nil,
    render_layer = "air-object",
    render_layer_when_on_ground = "lower-object-above-shadow",
    movement_modifier = 0.1
  ...
  make_particle{
    ...
    life_time = 64,
    pictures = particle_animations.get_bismuth_asteroid_particle_top_big_pictures({scale = 1}),
    shadows = particle_animations.get_bismuth_asteroid_particle_top_big_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
    regular_trigger_effect = nil,
    render_layer = "air-object",
    render_layer_when_on_ground = "lower-object-above-shadow",
  ...
  make_particle{
    ...
    life_time = 160,
    pictures = particle_animations.get_bismuth_asteroid_particle_big_pictures(),
    shadows = particle_animations.get_bismuth_asteroid_particle_big_pictures({tint=shadowtint(), shift=util.by_pixel(1,0)}),
    regular_trigger_effect = nil,
    render_layer_when_on_ground = "lower-object-above-shadow",
    movement_modifier = 0.1
  },
