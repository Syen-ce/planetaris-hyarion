...
![Alt text](https://i.imgur.com/Qb85yTO.jpeg)

# Is it safe to add the mod to an existing save?
At this point is completely safe to play in an existing save, it doesn't modify any base recipes or technologies
...
![Alt text](https://i.imgur.com/i8OXUHp.jpeg)
